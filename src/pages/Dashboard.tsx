...
export default function Dashboard() {
  ...
  return <div className="h-screen overflow-hidden">
      ...
      <div className="relative z-10 pt-20 px-6 h-full">
        <div className="max-w-[1600px] mx-auto h-full pb-6">
          <div className="glass-card rounded-[3rem] p-4 relative overflow-hidden border border-white/20 h-full">
